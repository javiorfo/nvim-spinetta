...
local spinetta_arrow = spinetta:new{ speed_ms = 400, spinner = spinetta.ARROW_SPINNER, main_msg = "Arrows ",
    final_msg = "Arrows finished!" }
spinetta_arrow:start(spinetta.job_to_run(my_job))


--Values speed_ms, spinner and final_msg set by parameters
local spinetta_equals = spinetta:new{ speed_ms = 100, spinner = spinetta.EQUALS_SPINNER, final_msg = "Equals finished!" }
...
local spinetta_ping_pong = spinetta:new{ spinner = spinetta.PING_PONG_SPINNER, speed_ms = 50 }
...
local spinetta_bar = spinetta:new{ spinner = spinetta.PROGRESS_BAR_SPINNER, final_msg = "Done!", main_msg = "Loading ", interrupted_msg = "Interrupted!" }
