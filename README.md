...
#### SPINNERS
- Check the spinners availables in [this file](https://github.com/chaosystema/nvim-spinetta/blob/master/lua/spinetta/spinners.lua)
- You can add your own spinner if you like. Further information in `:help spinetta`

## Screenshots
#### Examples of the differents spinners included in this plugin. Run `:luafile %` in [this file](https://github.com/chaosystema/nvim-spinetta/blob/master/examples/test_spinners.lua)

<img src="https://github.com/chaosystema/img/blob/master/nvim-spinetta/spinetta.gif?raw=true" alt="spinetta" />

#### Examples of interruption message included in this plugin. Run `:luafile %` and interrupt the process with `Ctrl-C` in [this file](https://github.com/chaosystema/nvim-spinetta/blob/master/examples/test_interruption.lua)
<img src="https://github.com/chaosystema/img/blob/master/nvim-spinetta/interrupt.gif?raw=true" alt="spinetta" />
